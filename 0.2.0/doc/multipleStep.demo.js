...
/******/ 	__webpack_require__.p = "/upload.react/0.2.0";
/******/
...
var _upload = __webpack_require__("./lib/index.js");
...
var MultipleStep = function (_React$Component) {
    _inherits(MultipleStep, _React$Component);

    function MultipleStep(props) {
        _classCallCheck(this, MultipleStep);

        var _this = _possibleConstructorReturn(this, (MultipleStep.__proto__ || Object.getPrototypeOf(MultipleStep)).call(this, props));
            ...
            return __webpack_require__("./node_modules/react/index.js").createElement(
                ...
                __webpack_require__("./node_modules/react/index.js").createElement(
                    ...
                    { name: 'file', action: '/upload',
                        ...
                        onChange: function onChange(files) {
                            ...
                            */
                            files.forEach(function (file) {
                                _upload.UploadFile.upload(file.id);
                            });
                        },
                        ...
                        onUpload: function onUpload(res, file) {
                            res = JSON.parse(res);
                            var images = self.state.images;
                            images.some(function (item, index) {
                                if (item.fileid === file.id) {
                ...
                self.state.images.map(function (item) {
                    ...
                    return __webpack_require__("./node_modules/react/index.js").createElement(
                        'div',
                        null,
                        __webpack_require__("./node_modules/react/index.js").createElement('img', { src: item.src, alt: '' }),
                        item.step,
                        __webpack_require__("./node_modules/react/index.js").createElement(
                            'button',
...
MultipleStep = __webpack_require__("./node_modules/react-hot-loader/index.js").hot(module)(MultipleStep);
module.exports = MultipleStep;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__("./node_modules/webpack/buildin/module.js")(module)))

/***/ }),

/***/ "./doc/multipleStep.demo.js":
/***/ (function(module, exports, __webpack_require__) {
...
var MultipleStep = __webpack_require__("./doc/MultipleStep.js");
ReactDOM.render(__webpack_require__("./node_modules/react/index.js").createElement(MultipleStep, null), document.getElementById('multipleStep-demo'));
...
var _uid = __webpack_require__("./lib/uid.js");

var _uid2 = _interopRequireDefault(_uid);

var _request = __webpack_require__("./lib/request.js");
...
var _getThumb = __webpack_require__("./lib/getThumb.js");

var _getThumb2 = _interopRequireDefault(_getThumb);

var _isLimit = __webpack_require__("./lib/isLimit.js");

var _isLimit2 = _interopRequireDefault(_isLimit);
...
var awaitFileLists = {};
var awaitFileUploadProps = {};

var uploadfile = function uploadfile(settings) {
    var uid = settings.id || '';
    var file = awaitFileLists[uid] || {};
    var props = awaitFileUploadProps[uid] || {};
...
var AjaxUpload = function (_Component) {
    ...
    _createClass(AjaxUpload, [{
        key: 'onChange',
        value: function onChange(fileData) {
            var self = this;
            ...
            for (var i = 0; i < fileData.length; i++) {
                // 限制判断
                var limit_result = (0, _isLimit2.default)(fileData[i]);
                ...
                /* 文件夹的判断 不精确 && 当选择了上传文件夹是忽略此限制判断
                    ...
                    errFilesLists.push({
                        ...
                        files[i] = fileData[i];
                        files[i].id = fileData[i].lastModified || fileData[i].lastModifiedDate.getTime() || (0, _uid2.default)();
                        files[i].thumb = (0, _getThumb2.default)({
            ...
            for (var _i = 0; _i < files.length; _i++) {
                if (typeof files[_i] !== 'undefined') {
                    filesArray.push((0, _extend2.default)(true, {}, files[_i]));
                }
            }
            // 有正确可上传文件才抛出
        ...
        key: 'toggleWebkitDirectory',
        value: function toggleWebkitDirectory() {
            var self = this;
        ...
        value: function render() {
            var self = this;
            var ref = _util2.default.ref(this);
...
__webpack_require__("./lib/props.js").default(AjaxUpload);
...
function getThumb(settings) {
	settings = settings || {};
	// 获取文件格式大类
	var fileType = 'unknown'; // 文件大类
	fileType = settings.fileData.type.split('/')[0] || fileType;
	// console.log('fileType : ',fileType)
	// 文件后缀名
	var fileFormat = '';
	fileFormat = settings.fileData.name.replace(/.+\/([^\/]+)$/, '$1');
	fileFormat = fileFormat.substr(fileFormat.lastIndexOf(".") == -1 ? fileFormat.length : fileFormat.lastIndexOf(".")).substr(1).toLowerCase() || 'default';
	// console.log('fileFormat : ',fileFormat)

	var thumb = false;

	// priority 1
	if (window.URL && fileType == 'image' && fileFormat != 'psd') {
		// 清除释放
	...
	if (thumb === false) {
		// 获取文件格式
		var config = (0, _extend2.default)(true, settings.defaultThumb, settings.thumbProps);
...
var _ajaxUpload = __webpack_require__("./lib/ajaxUpload.js");
...
var UploadPicker = function (_Component) {
    _inherits(UploadPicker, _Component);

    function UploadPicker() {
        _classCallCheck(this, UploadPicker);

        return _possibleConstructorReturn(this, (UploadPicker.__proto__ || Object.getPrototypeOf(UploadPicker)).apply(this, arguments));
    }

    _createClass(UploadPicker, [{
        key: "render",
        value: function render() {
            var self = this;
            var pcls = self.props.prefixClassName;
            var themesClassName = _util2.default.themes(this.props);
            return __webpack_require__("./node_modules/react/index.js").createElement(
                "div",
                { className: pcls + " " + themesClassName },
                __webpack_require__("./node_modules/react/index.js").createElement(_ajaxUpload2.default, self.props)
            );
        }
    }]);
...
__webpack_require__("./lib/props.js").default(UploadPicker);
exports.UploadFile = _ajaxUpload.uploadfile;
exports.default = UploadPicker;
...
var __isLimit = function () {
	function __isLimit(props) {
		_classCallCheck(this, __isLimit);

		this.file = props;
	}

	_createClass(__isLimit, [{
		key: 'type',
		value: function type(allowArray) {
			if (Array.isArray(allowArray) && allowArray.length > 0) {
				var fileFormat = this.file.name.replace(/.+(\..+)$/, '$1');
				var allow = allowArray.indexOf(fileFormat) != -1;
				if (allow) {
					return false;
				} else {
					return true;
...
function isLimit(fileData) {
	var file = (0, _extend2.default)(true, {}, fileData);
	return new __isLimit(file);
}

exports.default = isLimit;
...
exports.uploadfileProps = undefined;
...
var UploadPickerProps = function UploadPickerProps(app) {
    var _text;
    ...
    app.defaultProps = {
        ...
        onPick: function onPick(files) {},
        onError: function onError(errFiles) {},
        ...
        thumb: { //缩略图默认配置
            ...
            text: (_text = {
                ...
                "asp": "", "bak": "", "bat": "", "bin": "", "cfg": "", "cgi": "", "chk": "", "chm": "", "cmd": "", "com": "", "dat": "", "dbf": "", "dll": "", "htm": "", "html": "", "doc": "", "dot": "", "drv": "", "eml": "", "exe": "", "fon": "", "hlp": "", "inf": "", "ini": "", "jar": "", "log": "", "msg": "", "msi": "", "ocx": "", "pdf": "", "php": "", "ppt": "", "reg": "", "sys": "", "ttf": "", "txt": "", "rtf": "", "xls": "", "xlt": "", "aca": "", "acf": "", "acm": "" }, _defineProperty(_text, 'asp', ""), _defineProperty(_text, "bbs", ""), _defineProperty(_text, 'bin', ""), _defineProperty(_text, "c", ""), _defineProperty(_text, "cal", ""), _defineProperty(_text, "cdf", ""), _defineProperty(_text, "cdx", ""), _defineProperty(_text, 'cfg', ""), _defineProperty(_text, 'chm', ""), _defineProperty(_text, "clp", ""), _defineProperty(_text, "cnf", ""), _defineProperty(_text, "cnt", ""), _defineProperty(_text, "col", ""), _defineProperty(_text, "cpl", ""), _defineProperty(_text, "cpp", ""), _defineProperty(_text, "crd", ""), _defineProperty(_text, "crt", ""), _defineProperty(_text, "cur", ""), _defineProperty(_text, "css", ""), _defineProperty(_text, 'dat', ""), _defineProperty(_text, 'dbf', ""), _defineProperty(_text, "dcx", ""), _defineProperty(_text, "ddi", ""), _defineProperty(_text, "dev", ""), _defineProperty(_text, "dir", ""), _defineProperty(_text, 'dll', ""), _defineProperty(_text, "dos", ""), _defineProperty(_text, "der", ""), _defineProperty(_text, "dic", ""), _defineProperty(_text, "err", ""), _defineProperty(_text, "exp", ""), _defineProperty(_text, "exc", ""), _defineProperty(_text, "fp", ""), _defineProperty(_text, "fnd", ""), _defineProperty(_text, "for", ""), _defineProperty(_text, "fot", ""), _defineProperty(_text, "fpt", ""), _defineProperty(_text, "frt", ""), _defineProperty(_text, "frx", ""), _defineProperty(_text, "fxp", ""), _defineProperty(_text, "grh", ""), _defineProperty(_text, "goc", ""), _defineProperty(_text, "gra", ""), _defineProperty(_text, "h", ""), _defineProperty(_text, 'hlp', ""), _defineProperty(_text, "hqx", ""), _defineProperty(_text, "ht", ""), _defineProperty(_text, 'htm', ""), _defineProperty(_text, "idx", ""), _defineProperty(_text, "iff", ""), _defineProperty(_text, "ime", ""), _defineProperty(_text, "inc", ""), _defineProperty(_text, 'inf', ""), _defineProperty(_text, "lnk", ""), _defineProperty(_text, "mdb", ""), _defineProperty(_text, "men", ""), _defineProperty(_text, 'rtf', ""), _defineProperty(_text, "sav", ""), _defineProperty(_text, "scp", ""), _defineProperty(_text, "scr", ""), _defineProperty(_text, "sct", ""), _defineProperty(_text, "scx", ""), _defineProperty(_text, "set", ""), _defineProperty(_text, "shb", ""), _defineProperty(_text, "sql", ""), _defineProperty(_text, "swg", ""), _defineProperty(_text, 'sys', ""), _text),
            unknown: {
    ...
    app.propTypes = {
        ...
        allow: _propTypes2.default.array,
        size: _propTypes2.default.number,
        // type:p.string,
        multiple: _propTypes2.default.bool,
        onPick: _propTypes2.default.func,
        onError: _propTypes2.default.func,
        data: _propTypes2.default.object, // 提交时附带数据
        headers: _propTypes2.default.object,
        thumb: _propTypes2.default.object, // 缩略图配置
        withCredentials: _propTypes2.default.bool // ajax upload with cookie send (default:false)
    };
    app.propExample = {
        allow: example(['.jpg', '.png', '.gif']),
        size: example(1024, 5),
        thumb: example({
            image: {
...
var uploadfileProps = function uploadfileProps(app) {
    app.defaultProps = {};
    app.propTypes = {
        ...
        onError: _propTypes2.default.func,
        onXhrError: _propTypes2.default.func
    };
    app.propExample = {
        onProgress: example(function (step, file) {}),
        onSuccess: example(function (res) {}),
        onError: example(function (err, res) {}),
        onXhrError: example(function (e) {})
    };
    app.propsDesc = {};
};

exports.uploadfileProps = uploadfileProps;
exports.default = UploadPickerProps;
...
// module
exports.push([module.i, "/* Although the file suffix is CSS, but it will be less compilation */\n/* The CSS specification: https://github.com/fast-flow/trees */\n/* Base style */\n.face-upload-xhr {\n  position: relative;\n}\n.face-upload-xhr-input {\n  display: none;\n}\n.face-upload-iframe-label {\n  position: relative;\n}\n.face-upload-iframe-iframe,\n.face-upload-iframe-form,\n.face-upload-iframe-form-input {\n  /* 不能设为display:none; 否则ie下无法聚焦触发提交表单  */\n  width: 0;\n  height: 0;\n  opacity: 0;\n  position: absolute;\n  top: 0;\n  left: 0;\n  z-index: -10;\n}\n/* Configurable style */\n", ""]);
...
module.exports = __webpack_require__("./doc/multipleStep.demo.js");
